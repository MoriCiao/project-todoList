...
const ImgSticky = ({ color = "green" }) => {
  ...
  return (
    <img
      src={color === "green" ? imgGreen : imgYellow}
      alt="動畫便條紙"
...
export default function TodoAnimite() {
  ...
  return (
    <div className="relative flex h-full w-full items-center justify-center sm:h-full">
      ...
      <motion.div
        ...
        className='flex h-full w-full flex-col items-center justify-center gap-8 font-["Luckiest_Guy"] tracking-widest select-none lg:flex-row'
      >
